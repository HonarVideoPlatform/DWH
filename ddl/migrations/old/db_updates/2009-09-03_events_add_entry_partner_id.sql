...
ALTER TABLE kalturadw.dwh_fact_events MODIFY entry_id VARCHAR(20),  ADD COLUMN entry_partner_id INT after entry_media_type_id;

# add field on kalturadw_ds.DS_Events
ALTER TABLE kalturadw_ds.DS_Events MODIFY entry_id VARCHAR(20),   ADD COLUMN entry_partner_id INT after entry_media_type_id;
...
BEGIN
	SET @s = CONCAT('insert into kalturadw.dwh_fact_events
			 ...
			 process_duration, control_id, seek, new_point, domain_id, referrer , entry_media_type_id
			,entry_partner_id   
