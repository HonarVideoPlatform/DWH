...
BEGIN
 ...
 INSERT INTO kalturadw.dwh_fact_bandwidth_usage
	(file_id,	cycle_id,	partner_id,		activity_date, 		activity_date_id,	activity_hour_id,	bandwidth_source_id,	url,	bandwidth_kb,		user_agent_id)
  SELECT NULL, 		NULL, 		session_partner_id, 	DATE(session_time),	session_date_id,	0,			FMS_BANDWIDTH_SOURCE,	NULL,	SUM(total_bytes),	NULL
